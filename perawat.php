    ...
    <div class="container" style="margin-top: 100px;">
      <div class="card text-center">
        <div class="card-header">
          <a href="add_perawat.php" class="btn btn-secondary"><i class="fas fa-plus"></i> Tambah Perawat</a>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>  
                  <a href="edit_perawat.php?ID_Perawat=<?php echo $barisdata["ID_Perawat"]; ?>" class="btn btn-primary"><i class="fas fa-user-edit"></i> Ubah</a>
                  <a href="delete_perawat.php?ID_Perawat=<?php echo $barisdata["ID_Perawat"]; ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Hapus</a>
                </td>
              </tr>
            </tbody>
            <?php 
